...
func _on_state_transitioned(new_state_name):
	_deferred_on_state_transitioned.call_deferred(new_state_name)


func _deferred_on_state_transitioned(new_state_name):
